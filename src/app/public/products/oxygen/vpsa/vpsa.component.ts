...
@Component({
  selector: 'app-vpsa',
  templateUrl: './vpsa.component.html',
  styleUrls: ['./vpsa.component.css']
})
export class VpsaComponent implements OnInit {
  constructor(private seoService: SeoService){

  }
  ngOnInit(): void {
    this.seoService.updateTitle("PVSA");
    this.seoService.updateDescription("PVSA a product of the Gaztron Company");
  }
  options: any = [
