...
@Component({
  selector: 'app-gox-c',
  templateUrl: './gox-c.component.html',
  styleUrls: ['./gox-c.component.css']
})
export class GoxCComponent implements OnInit {
  constructor(private seoService: SeoService){

  }
  ngOnInit(): void {
    this.seoService.updateTitle("GOX-C");
    this.seoService.updateDescription("GOX-C a product of the Gaztron Company");
  }
  options: any = [
