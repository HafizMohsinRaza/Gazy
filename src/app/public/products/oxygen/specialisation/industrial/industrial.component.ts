...
export class IndustrialComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.seoService.updateTitle("Industrial");
    this.seoService.updateDescription("Industrial a product of the Gaztron Company");
  }
  options: any = [
    {value: 'option-0', viewValue: 'Oxygen Generator (GOX-M Model)'},
    {value: 'option-1', viewValue: 'Oxygen Generator (GOX-I Model)'},
    {value: 'option-2', viewValue: 'Oxygen Generator (GOX-C Model)'},
  ]
  questions: any =[
    {
      id: 1,
