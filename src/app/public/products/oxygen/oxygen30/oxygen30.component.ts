...
@Component({
  selector: 'app-oxygen30',
  templateUrl: './oxygen30.component.html',
  styleUrls: ['./oxygen30.component.css']
})
export class Oxygen30Component implements OnInit {
  constructor(private seoService: SeoService){

  }
  ngOnInit(): void {
    this.seoService.updateTitle("Oxygen(30-60 NM3)");
    this.seoService.updateDescription("Oxygen(30-60 NM3) a product of the Gaztron Company");
  }
  options: any = [
