...
@Component({
  selector: 'app-ammonia-purifier',
  templateUrl: './ammonia-purifier.component.html',
  styleUrls: ['./ammonia-purifier.component.css']
})
export class AmmoniaPurifierComponent  implements OnInit {
  constructor(private seoService: SeoService){

  }
  ngOnInit(): void {
    this.seoService.updateTitle("Ammonia Purifier");
    this.seoService.updateDescription("Ammonia Purifier a product of the Gaztron Company");
  }
  options: any = [
