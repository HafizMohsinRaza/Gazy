...
@Component({
  selector: 'app-dx-model',
  templateUrl: './dx-model.component.html',
  styleUrls: ['./dx-model.component.css']
})
export class DxModelComponent implements OnInit {
  constructor(private seoService: SeoService){

  }
  ngOnInit(): void {
    this.seoService.updateTitle("DX Model");
    this.seoService.updateDescription("DX Model a product of the Gaztron Company");
  }
  options: any = [
