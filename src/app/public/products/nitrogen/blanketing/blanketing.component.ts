...
@Component({
  selector: 'app-blanketing',
  templateUrl: './blanketing.component.html',
  styleUrls: ['./blanketing.component.css']
})
export class BlanketingComponent implements OnInit {
  constructor(private seoService: SeoService){

  }
  ngOnInit(): void {
    this.seoService.updateTitle("Blanketing");
    this.seoService.updateDescription("Blanketing a product of the Gaztron Company");
  }
  options: any = [
