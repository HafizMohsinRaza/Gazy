...
@Component({
  selector: 'app-food-packaging',
  templateUrl: './food-packaging.component.html',
  styleUrls: ['./food-packaging.component.css']
})
export class FoodPackagingComponent  implements OnInit {
  constructor(private seoService: SeoService){

  }
  ngOnInit(): void {
    this.seoService.updateTitle("Food Packaging");
    this.seoService.updateDescription("Food Packaging a product of the Gaztron Company");
  }
  options: any = [
